...
- **Real-time updates** — Server-Sent Events (see [`docs/sse-design.md`](docs/sse-design.md))
...
docs/erd.puml           entity-relationship diagram (PlantUML)
docs/sse-design.md      design doc for the real-time results stream
```
...
limitations are in [`docs/sse-design.md`](docs/sse-design.md); the data model is in
[`docs/erd.puml`](docs/erd.puml) and [`backend/SCHEMA.md`](backend/SCHEMA.md).
